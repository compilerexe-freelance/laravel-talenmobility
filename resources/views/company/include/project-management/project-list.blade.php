		  <script>
               ...
               appendModal("{{ url('company/delete-project-modal') }}", "projectDelModal");			
            });
          </script>
          ...
          <div class="row" style="padding:5px">
              ...
              <div class="tab-wrapper tab-default">
                ...
                <div class="tab-content">
                  ...
                  width="inherit" cellspacing="0">
                        <thead>
                          <tr>
                            <th style="width: 80%">รายชื่อโครงการ</th>
            ...
            <div class="row-fluid">
            	<a class="btn btn-default pull-left btn-addFormList"
             	id="btn-addproject" onclick="registerProj('')" style="margin-right:5px">
              		<i class="fa fa-plus-circle"></i> เพิ่มโครงการ
            	</a>
          	</div>

            <div class="row-fluid" style="margin: 5px 0px;color: green">
                สถานะ ( P0:ริ่มโครงการ,
                P1:ค้นหาจับคู่นักวิจัยู่,
                P2:ทำข้อเสนอโครงการ,
                P3:ทำสัญญา,
                P4:ประเมินโครงการ,
                P5:สิ้นสุดโครงการ/ทำรายงานฉบับสมบูรณ์,
                P6:ยกเลิกโครงการ)
            </div>
