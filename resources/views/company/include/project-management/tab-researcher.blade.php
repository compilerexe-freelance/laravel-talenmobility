  <script>
  	$(document).ready(function() {
		appendModal("{{ url('company/confirm-researcher-and-student-modal') }}", "confirmResearcherModal");
		appendModal("{{ url('company/delete-researcher-modal') }}", "delResearcher");
		appendModal("{{ url('company/selected-reasearcher-and-student-modal') }}", "selectedResearcherModal");
                     ...
                     class="table table-striped table-bordered table-hover profileBox">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td width="10%">2</td>
                          <td width="10%" class="greenlink">
                          	<a href="#" class="selectedResearcherLink">2</a>
                          </td>
                        ...
                        <tr>
                          ...
                          <td width="10%">4</td>
                          <td width="10%" class="greenlink">
                          	<a href="#" class="selectedResearcherLink">1</a>
                          </td>
                          <th width="2%" class="text-center">
                            <a class="btn btn-danger btn-deldata btn-sm no_bot_margin" 
                        ...
                        <tr>
                          ...
                          <td width="10%">5</td>
                          <td width="10%" class="greenlink">
                          	<a href="#" class="selectedResearcherLink">3</a>
                          </td>
                          <th width="2%" class="text-center">
                            <a class="btn btn-danger btn-deldata btn-sm no_bot_margin" 
