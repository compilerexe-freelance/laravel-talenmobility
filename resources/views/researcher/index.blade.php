...
<script>
	...
	$(document).ready(function() {
		...
		$("#panel_header").text('ข้อมูลเบื้องต้น');;
		loadContent("{{ url('researcher/basic-info') }}");
		...
		$('a').click(function() { 
			...
			if(id == "info"){
				...
				$("#panel_header").text('รายละเอียดสังกัด');
				loadContent("{{ url('researcher/institute') }}");
			}
			else if(id == "address"){
				$("#panel_header").text('รายละเอียดที่อยู่');;
				loadContent("{{ url('researcher/address') }}");
			}
			else if(id == "workhist"){
				$("#panel_header").text('ประวัติการทำงาน');;
				loadContent("{{ url('researcher/work-history') }}");
			}
			else if(id == "education"){
				$("#panel_header").text('ประวัติการศึกษา');;
				loadContent("{{ url('researcher/education') }}");
			}
			else if(id == "achievement"){
				$("#panel_header").text('ผลงานที่ผ่านมา');;
				loadContent("{{ url('researcher/achievement') }}");
			}
			else if(id == "award"){
				$("#panel_header").text('รางวัลที่เคยได้รับ');;
				loadContent("{{ url('researcher/award') }}");
			}
			else if(id == "tm"){
				$("#panel_header").text('Talent Mobility');;
				loadContent("{{ url('researcher/talent-mobility') }}");
			}
		});
	});
        ...
        <div class="sidebar-profile">
          ...
          <div class="profile-body dropdown"> 
            <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                ...
                <div>
                    <small class="title">Researcher</small>
                </div>
                <div>
        ...
        <nav>
          ...
          <ul class="nav nav-pills nav-stacked">
            <li class="nav-dropdown active"> <a href="#" id="info"> 
                <i class="fa fa-fw fa-info-circle"></i> ข้อมูลเบื้องต้น </a> 
            </li>
            <li class="nav-dropdown"> 
                <a href="#" onClick="navigate();" id="institute"> <i class="fa fa-fw fa-institution"></i> สังกัด </a>
            </li>
            <li class="nav-dropdown"> 
                <a href="#" onClick="navigate();" id="address"> <i class="fa fa-fw fa-location-arrow"></i> ที่อยู่ </a>
            </li>
            <li class="nav-dropdown"> 
                <a href="#" onClick="navigate();" id="workhist"> <i class="fa fa-fw fa-history"></i> ประวัติการทำงาน </a>
            </li>
             <li class="nav-dropdown"> 
                <a href="#" onClick="navigate();" id="education"> <i class="fa fa-fw  fa-graduation-cap"></i> ประวัติการศึกษา </a>
            </li>
            <li class="nav-dropdown"> 
                <a href="#" onClick="navigate();" id="achievement"> <i class="fa fa-fw fa-tasks"></i> ผลงาน </a>
            </li>
            <li class="nav-dropdown"> 
                <a href="#" onClick="navigate();" id="award"> <i class="fa fa-fw fa-trophy"></i> รางวัล </a>
            </li>
            <li class="nav-dropdown"> 
                <a href="#" onClick="navigate();" id="tm"> <i class="fa fa-fw fa-star-o"></i> Talent Mobility </a> </li>
          </ul>
        </nav>
        </aside>
